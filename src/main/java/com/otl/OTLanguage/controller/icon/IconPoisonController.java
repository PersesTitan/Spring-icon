...
@RestController
@RequestMapping("/icon/poison")
public class IconPoisonController implements IconPoison {

    @GetMapping(value = "/flat", produces = "image/svg+xml")
    public String flat(@RequestParam(value = "iconColor", defaultValue = "FFFFFF") String iconColor,
    ...
    public String forTheBadge(@RequestParam(value = "iconColor", defaultValue = "FFFFFF") String iconColor,
                              @RequestParam(value = "textColor", defaultValue = "FFFFFF") String textColor,
                              @RequestParam(value = "backgroundColor", defaultValue = "A900FF") String backgroundColor) {
